...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1><span class="glyphicon glyphicon-usd" aria-hidden="true"></span>&nbsp;付款 </h1>
        </div>
        ...
        <c:forEach items="${requestScope.orderForms}" var="orderForm">
            <div class="row">
                    ...
                    <div class="col-md-2" style="margin-top: 55px;"><h4>${orderForm.count}</h4></div>
                    <div class="col-md-2" style="margin-top: 55px"><h4>${orderForm.totalPrice}</h4></div>
            </div>
            <hr>
        </c:forEach>
        ...
        <div class="row">
            ...
            <div class="col-sm-3"></div>
            <div class="col-sm-3">
                <h4>合计：&nbsp;￥${requestScope.total}</h4>
                <p>
                    <a href="/order/myCart?user_id=${user.id}" type="button" class="btn btn-default">&nbsp;&nbsp;取消&nbsp;&nbsp;</a>
                    <a href="/order/subOrder?user_id=${sessionScope.user.id}" type="button" class="btn btn-primary">&nbsp;&nbsp;确定付款&nbsp;&nbsp;<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a>
                </p>
            </div>
        </div>
    </div>
